...
namespace GDC.EventHost.API.Migrations
{
    ...
    [Migration("20241217113934_AddSeries")]
            ...
            modelBuilder.Entity("GDC.EventHost.API.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 1, 6, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(1016),
                            ...
                            StartDate = new DateTime(2024, 12, 22, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(909),
                            StatusId = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 1, 6, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(1213),
                            LongDescription = "Deadlights jack lad schooner scallywag dance the hempen jig carouser broadside cable strike colors. Bring a spring upon her cable holystone blow the man down spanker Shiver me timbers to go on account lookout wherry doubloon chase. Belay yo-ho-ho keelhaul squiffy black spot yardarm spyglass sheet transom heave to.",
                            SeriesId = new Guid("9bbe4e74-6ae9-489d-a345-d81f7e3708e2"),
                            StartDate = new DateTime(2024, 12, 22, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(1211),
                            StatusId = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 1, 6, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(1216),
                            ...
                            StartDate = new DateTime(2024, 12, 22, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(1215),
                            StatusId = 1,
            ...
            modelBuilder.Entity("GDC.EventHost.API.Entities.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2024, 12, 24, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(1664),
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2024, 12, 31, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(2333),
                            EventId = new Guid("87a4b2be-eeab-4c59-a01d-e5fa1621706b"),
                            PerformanceTypeId = new Guid("af3bba31-bb59-4638-ad4b-dc62d7315d06"),
                            StatusId = 1,
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2025, 1, 7, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(2339),
                            EventId = new Guid("87a4b2be-eeab-4c59-a01d-e5fa1621706b"),
                            PerformanceTypeId = new Guid("af3bba31-bb59-4638-ad4b-dc62d7315d06"),
                            StatusId = 1,
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2024, 12, 22, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(2341),
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2024, 12, 27, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(2343),
                            EventId = new Guid("a0292853-7d7c-431f-9545-addb443296fd"),
                            PerformanceTypeId = new Guid("af3bba31-bb59-4638-ad4b-dc62d7315d06"),
                            StatusId = 1,
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2024, 12, 22, 11, 39, 34, 380, DateTimeKind.Local).AddTicks(2345),
            ...
            modelBuilder.Entity("GDC.EventHost.API.Entities.Series", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("50108347-73eb-41a2-a9d0-3e0b78d2e432"),
                            Description = "Integer tempus himenaeos suscipit penatibus mauris a a ultrices netus.",
                            EndDate = new DateTime(2025, 2, 15, 11, 39, 34, 379, DateTimeKind.Local).AddTicks(6243),
                            ...
                            StartDate = new DateTime(2024, 12, 17, 11, 39, 34, 379, DateTimeKind.Local).AddTicks(5992),
                            StatusId = 1,
                            Title = "Series One"
                        },
                        new
                        {
                            Id = new Guid("9bbe4e74-6ae9-489d-a345-d81f7e3708e2"),
                            Description = "Sagittis varius justo aliquam dignissim nascetur mauris neque.",
                            EndDate = new DateTime(2025, 2, 15, 11, 39, 34, 379, DateTimeKind.Local).AddTicks(6446),
                            ...
                            StartDate = new DateTime(2024, 12, 17, 11, 39, 34, 379, DateTimeKind.Local).AddTicks(6443),
                            StatusId = 1,
                            Title = "Series Two"
                        },
                        new
                        {
                            Id = new Guid("460cec3a-6406-4f74-b9b2-065d3e140026"),
                            Description = "Facilisis nulla turpis proin fames fusce condimentum praesent lacus dui.",
                            EndDate = new DateTime(2025, 2, 15, 11, 39, 34, 379, DateTimeKind.Local).AddTicks(6449),
                            ...
                            StartDate = new DateTime(2024, 12, 17, 11, 39, 34, 379, DateTimeKind.Local).AddTicks(6448),
                            StatusId = 1,
                            Title = "Series Three"
                        });
                });
